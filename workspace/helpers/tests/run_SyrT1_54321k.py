...
Iterations: [5000, 4000, 3000, 1000]  (4 resolution levels, descending)
No preprocessing filters: run_flags=(0,0,0), pad=False
"""
import os, sys, time
...
save_dir         = '/Users/hoomham/Hooman/Work/Analysis/2025-05-14_SyrT1/reg/54321k_nofilter/'
run_flags        = (0, 0, 0)
pad              = False
save_intermediate = False
iterations       = ['5000', '4000', '3000', '1000']
refno            = 9    # EI = frame 9 (highest signal sum)
# ─────────────────────────────────────────────────────────────────────────────
