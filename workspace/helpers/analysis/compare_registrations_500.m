...
runs = { ...
    'ablation_500iter_pad_image_only',   'image'; ...
    'ablation_500iter_pad_enhance',     'enhance'; ...
    'ablation_500iter_pad_denoise',  'denoise'; ...
    'ablation_500iter_pad_clahe',  'clahe'; ...
    'ablation_500iter_full',     'full'; ...
    'ablation_500iter_npad_enhance',     'enhancen'; ...
    'ablation_500iter_npad_denoise',     'denoisen'; ...
    'ablation_500iter_npad_clahe',     'clahen'; ...
};
n_runs = size(runs, 1);
    ...
    for r = 1:n_runs
        ...
        for c = 1:n_ch
            ...
            if c == 1
                ...
                err_map            = computePCAError(vol, numcomp);
