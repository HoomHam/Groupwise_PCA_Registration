...
def main():
    ...
    clahe2  = create_clahe_from_4d_image(image)
    sitk.WriteImage(clahe2, os.path.join(save_dir, "clahe2_init.nii"))
    ...
    image4D, mask4D, clahe4D = register_stepwise(image, clahe, endinhale, os.path.join(save_dir, 'stepwise/'))
    e2 = time.time()
