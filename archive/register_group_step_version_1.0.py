...
def read_files(directory):
    ...
    mask_file = find_file_with_prefix(directory, 'mspace')
    ...
    # Process masks
    masks = process_mat_file(mask_file, 'mask')
...
def register_pairwise_ants(image3D, mask3D, clahe3D, refno):
...
def main():
    ...
    image, mask, clahe = read_files(input_files)

    s1  = time.time()
    # Perform initial groupwise registration
    image4D, mask4D, clahe4D = register_groupwise(image, mask, clahe, os.path.join(save_dir, 'groupwise/1/'))
    #image4D = sitk.ReadImage('/Volumes/Macintosh HD 2/Work/Analysis/2023-03-03_032WS/groupwise/1/image_groupwise.nii')
    #image4D = sitk.ReadImage('/Volumes/Macintosh HD 2/Work/Analysis/2023-03-03_032WS/groupwise/1/image_groupwise.nii')
    #image4D = sitk.ReadImage('/Volumes/Macintosh HD 2/Work/Analysis/2023-03-03_032WS/groupwise/1/image_groupwise.nii')
    ...
    image4D, mask4D, clahe4D = register_groupwise(image4D, mask4D, clahe4D, os.path.join(save_dir, 'groupwise/2/'))
    e3 = time.time()
    ...
    refno = 7
    image3D, mask3D, clahe3D = register_pairwise_ants(image3D, mask3D, clahe3D, endinhale)
    e4 = time.time()
    ...
    image4D, mask4D, clahe4D = register_groupwise(image4D, mask4D, clahe4D, os.path.join(save_dir, 'groupwise/3/'))
    e5 = time.time()
