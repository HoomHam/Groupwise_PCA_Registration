...
def register_groupwise(image, clahe, savedir, enhanced, claheinternal, target_weights):
...
def main():
    ...
    image4D, mask4D, clahe4D = register_groupwise(image, clahe, os.path.join(save_dir, 'groupwise/0/'), enhanced=True, claheinternal=False, target_weights = [60])
    ...
    s1  = time.time()
    # Perform initial groupwise registration (False: USE INTERNAL CLAHE IF ENHANCED)
    image4D, mask4D, clahe4D = register_groupwise(image4D, clahe4D, os.path.join(save_dir, 'groupwise/1/'), enhanced=True, claheinternal=False, target_weights = [20])
    # image4D = sitk.ReadImage('/Volumes/Macintosh HD 2/Work/Analysis/2023-04-14_000KR/reg/groupwise/0/image_groupwise.nii')
    # mask4D = sitk.ReadImage('/Volumes/Macintosh HD 2/Work/Analysis/2023-04-14_000KR/reg/groupwise/0/mask_groupwise.nii')
    # clahe4D = sitk.ReadImage('/Volumes/Macintosh HD 2/Work/Analysis/2023-04-14_000KR/reg/groupwise/0/clahe_groupwise.nii') 
    e1 = time.time()
    ...
    image4D, mask4D, clahe4D = register_groupwise(image4D, clahe4D, os.path.join(save_dir, 'groupwise/2/'), enhanced=True, claheinternal=False, target_weights = [30])
    ...
    image4D, mask4D, clahe4D = register_groupwise(image4D, clahe4D, os.path.join(save_dir, 'groupwise/3/'), enhanced=False, claheinternal=False, target_weights = None)
