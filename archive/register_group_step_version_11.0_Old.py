...
def step_groupwise_registration(image, clahe, savedir):
    ...
    sitk.WriteImage(final_registration_results["resultImage4d"], os.path.join(savedir, "ns_final_image_groupwise.nii"))
    sitk.WriteImage(final_registration_results["resultClahe4d"], os.path.join(savedir, "ns_final_clahe_groupwise.nii"))
...
def main():
    ...
    image4D = sitk.ReadImage('/Volumes/Macintosh HD 2/Work/Analysis/2024-08-23_016PG/reg/5000/ns_final_image_groupwise.nii')
    clahe4D = sitk.ReadImage('/Volumes/Macintosh HD 2/Work/Analysis/2024-08-23_016PG/reg/5000/ns_final_clahe_groupwise.nii')
    ...
    sitk.WriteImage(image4Dn, os.path.join(save_dir, "ns_registered_orig.nii"))
    ...
    sitk.WriteImage(image4D, os.path.join(save_dir, "ns_registered_clahe.nii"))
