...
def create_bm3d_from_4d_image(image4d, noise_var = 0.5):
...
def main():
    ...
    image4D, mask4D, clahe4D = register_groupwise(image, clahe, os.path.join(save_dir, 'groupwise/0C/'), enhanced=False, claheinternal=False, target_weights = [10])
    ...
    s1  = time.time()
    # Perform initial groupwise registration (False: USE INTERNAL CLAHE IF ENHANCED)
    # image4D, mask4D, clahe4D = register_groupwise(image4D, clahe4D, os.path.join(save_dir, 'groupwise/1N/'), enhanced=True, claheinternal=False, target_weights = [15])
    ...
    # image4D, mask4D, clahe4D = register_groupwise(image4D, clahe4D, os.path.join(save_dir, 'groupwise/1/'), enhanced=True, claheinternal=False, target_weights = [30])
