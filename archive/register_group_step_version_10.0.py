...
# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-04-26_000ID/reg/5000/'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-04-26_000ID/rec/'
# endinhale = 5 
# refno = 5
# threshold = 0.055  # Cutoff value for mask creation
# time_threshold = 5
...
# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-12-15-003KH/reg/5000/'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-12-15-003KH/rec/'
# endinhale = 8 
# refno = 8
# threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 5

# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-03-12_006KL/reg/5000/'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-03-12_006KL/rec/'
# endinhale = 6 
# refno = 6
# threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 5
...
# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-11-03_000LL/reg/5000/'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-11-03_000LL/rec/'
# endinhale = 7 
# refno = 7
# threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 5
...
def register_groupwise(image, registeror, clahe, savedir, time_threshold, cyclic):
    ...
    sitk.WriteImage(clahe, os.path.join(savedir, "clahe.nii"))
    ...
    sitk.WriteImage(resultMask4d, os.path.join(savedir, "mask_groupwise.nii"))
    sitk.WriteImage(resultRegisteror4d, os.path.join(savedir, "registeror_groupwise.nii"))
...
def orchestrate_registration_workflow(image, clahe, savedir, target_weights, index_sets, cyclic):
    ...
    sitk.WriteImage(resultClahe4d_64, os.path.join(savedir, "clahe_init_64.nii")) 
...
def step_groupwise_registration(image, clahe, savedir):
    ...
    for index_range in index_ranges:
        ...
        sitk.WriteImage(Clahe4d, os.path.join(savedir, str(start_index), "clahe_init.nii"))
        ...
        sitk.WriteImage(UpdatedClahe4d, os.path.join(savedir, str(start_index), "clahe_update_01.nii"))
        ...
        sitk.WriteImage(finalCombinedClahe4d, os.path.join(savedir, str(start_index), "clahe_update_02.nii"))
...
def main():
    ...
    s0  = time.time()
    # sitk.WriteImage(clahe, os.path.join('/Volumes/Macintosh HD 2/Work/Analysis/2024-04-01_008CR/reg/', "clahe_init_00.nii"))
