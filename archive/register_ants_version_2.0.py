...
# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-12-06_003PM/t1a'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-12-06_003PM/t1a'
# endinhale = 0 
# refno = 0
# time_threshold = 2

# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-02-27_009JT/t1a'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-02-27_009JT/t1a'
# endinhale = 0 
# refno = 0
# time_threshold = 2

# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-10-08_009JT/t1a'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-10-08_009JT/t1a'
# endinhale = 0 
# refno = 0
# # threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 2

# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-01-31_008CR/t1a'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-01-31_008CR/t1a'
# endinhale = 0 
# refno = 0
# threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 2

# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-02-02_005DS/t1a'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-02-02_005DS/t1a'
# endinhale = 0 
# refno = 0
# threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 2

# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-10-02_018CS/t1a'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-10-02_018CS/t1a'
# endinhale = 0
# refno = 0
# threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 2 # Cutoff value for mask sum creation

# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-09-10_008TP/t1a'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-09-10_008TP/t1a'
# endinhale = 0
# refno = 0
# threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 2 # Cutoff value for mask sum creation

# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-10-02_011CN/t1a'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-10-02_011CN/t1a'
# endinhale = 0
# refno = 0
# threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 2 # Cutoff value for mask sum creation
...
# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-04-01_008CR/t1a'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-04-01_008CR/t1a'
# endinhale = 0 
# refno = 0
# threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 2 # Cutoff value for mask sum creation

# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-06-18_003PM/t1a/'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-06-18_003PM/t1a/'
# endinhale = 0
# refno = 0
# threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 2 # Cutoff value for mask sum creation

# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-11-17_005DS/t1a/'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-11-17_005DS/t1a/'
# endinhale = 0
# refno = 0
# threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 2 # Cutoff value for mask sum creation
...
# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-08-23_016PG/t1a/'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-08-23_016PG/t1a/'
# endinhale = 0
# refno = 0
# threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 2 # Cutoff value for mask sum creation
...
# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-03-28_010AJ/t1a/'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-03-28_010AJ/t1a/'
# endinhale = 0
# refno = 0
# threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 2 # Cutoff value for mask sum creation
...
# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-04-14_000KR/t1a/'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-04-14_000KR/t1a/'
# endinhale = 0
# refno = 0
# threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 2 # Cutoff value for mask sum creation

# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-12-15-003KH/t1a/'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-12-15-003KH/t1a/'
# endinhale = 0
# refno = 0
# threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 2 # Cutoff value for mask sum creation

# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-03-12_006KL/t1a/'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-03-12_006KL/t1a/'
# endinhale = 0
# refno = 0
# threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 2 # Cutoff value for mask sum creation
...
# save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-03-11_039CP/t1a/'
# input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-03-11_039CP/t1a/'
# endinhale = 0
# refno = 0
# threshold = 0.04  # Cutoff value for mask creation
# time_threshold = 2 # Cutoff value for mask sum creation

save_dir = '/Volumes/Macintosh HD 2/Work/Analysis/2024-09-24_039CP/t1a/'
input_files = '/Volumes/Macintosh HD 2/Work/Analysis/2024-09-24_039CP/t1a/'
endinhale = 0
refno = 0
threshold = 0.04  # Cutoff value for mask creation
time_threshold = 2 # Cutoff value for mask sum creation
...
def read_files(directory):
    ...
    # Find files with specific prefixes
    image_file = find_file_with_prefix(directory, 't1space_gas')
    clahe_file = find_file_with_prefix(directory, 'ct1space_gas')
...
def main():
    ...
    image4D = process_images(image, index_range=(0, 3)) 
    clahe4D = process_images(clahe, index_range=(0, 3)) 
    ...
    sitk.WriteImage(image4D, os.path.join(save_dir, "image_init.nii"))
    sitk.WriteImage(clahe4D, os.path.join(save_dir, "clahe_init.nii"))
    ...
    # sitk.WriteImage(image4D, os.path.join(save_dir, "registered_t1alpha.nii"))
    ...
    print('ANTs in progress...')   
    image3Do, clahe3Do = register_EI_ants(image3D, image3D, 0, save_dir)

    image4D = join_image3d_ants(image3Do)
    sitk.WriteImage(image4D, os.path.join(save_dir, "reg2atlas_orig.nii"))

    print('ANTs in progress...')   
    image3D, clahe3D = register_EI_ants(image3D, clahe3D, 0, save_dir)
    e6 = time.time()

    image4D = join_image3d_ants(image3D)
    sitk.WriteImage(image4D, os.path.join(save_dir, "reg2atlas_clahe.nii"))

    print('ANTs in progress...')   
    image3D, clahe3D = register_EI_ants(image3D, image3D, 0, save_dir)
    # e6 = time.time()
