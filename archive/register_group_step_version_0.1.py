...
# V0.1 added the mask connetivity
...
def register_groupwise(image, clahe, savedir):
    ...
    # sitk.WriteImage(mask, os.path.join("/Volumes/Macintosh HD 2/Work/Analysis/2023-05-15_035EK/reg/","mask_init.nii"))

    if mask.GetPixelIDTypeAsString() != '8-bit unsigned integer':
...
def register_stepwise(image, mask, clahe, refno, savedir):
    ...
    for y in range(2,n):
        ...
        for x in range(x_range):
            ...
            Mask4d = create_mask_from_4d_image(Image4d)
...
def main():
    ...
    # image4D, mask4D, clahe4D = register_groupwise(image, clahe, os.path.join(save_dir, 'groupwise/0/'))
    image4D = sitk.ReadImage('/Volumes/Macintosh HD 2/Work/Analysis/2023-05-15_035EK/reg/groupwise/0/image_groupwise.nii')
    mask4D = sitk.ReadImage('/Volumes/Macintosh HD 2/Work/Analysis/2023-05-15_035EK/reg/groupwise/0/mask_groupwise.nii')
    clahe4D = sitk.ReadImage('/Volumes/Macintosh HD 2/Work/Analysis/2023-05-15_035EK/reg/groupwise/0/clahe_groupwise.nii')
    ...
    s6  = time.time()
    # # Final registration    
    image3D, clahe3D = register_EI_ants(image3D, clahe3D, endinhale, save_dir)
    e6 = time.time()
